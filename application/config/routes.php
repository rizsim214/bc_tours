...
$route['hr_filter_home'] = 'welcome/hr_filter';
$route['br_filter_home'] = 'welcome/br_filter';
$route['mc_filter_home'] = 'welcome/mc_filter';
...
$route['one_category_home/(:num)'] = 'welcome/one_category_home/$1';
